/*
 * $Id: item_int64_array_const_setcopy.c 363 2022-02-10 12:15:04Z yeti-dn $
 *
 * Test int64 array item with constant and copied data.
 *
...
main(void)
{
    ...
    gwyfile_item_set_int64_array_copy(item, newvalue, newlen);
