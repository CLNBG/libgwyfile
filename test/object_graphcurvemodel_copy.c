/*
 * $Id: object_graphcurvemodel_copy.c 363 2022-02-10 12:15:04Z yeti-dn $
 *
 * Test GwyGraphCurveModel object constructor and extractor with copied data.
 *
...
main(void)
{
    ...
    assert(strcmp(gwyfile_object_name(graphcurvemodel), "GwyGraphCurveModel")
           == 0);
    gwyfile_object_add(graphcurvemodel, gwyfile_item_new_double("EXTRA_ITEM",
                                                                M_PI));
