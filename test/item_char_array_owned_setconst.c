/*
 * $Id: item_char_array_owned_setconst.c 363 2022-02-10 12:15:04Z yeti-dn $
 *
 * Test character array item with owned and constant data.
 *
...
main(void)
{
    ...
    assert(memcmp(gwyfile_item_get_char_array(item), newvalue, newlen*sizeof(char)) == 0);
