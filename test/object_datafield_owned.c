/*
 * $Id: object_datafield_owned.c 363 2022-02-10 12:15:04Z yeti-dn $
 *
 * Test GwyDataField object constructor and extractor with owned data.
 *
...
main(void)
{
    ...
    dataowned = malloc(2*3*sizeof(double));
    memcpy(dataowned, data, 2*3*sizeof(double));
    ...
    gwyfile_object_add(datafield, gwyfile_item_new_int32("EXTRA_ITEM", -10));
