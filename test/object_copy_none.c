/*
 * $Id: object_copy_none.c 363 2022-02-10 12:15:04Z yeti-dn $
 *
 * Test object copying.
 *
...
main(void)
{
    ...
    copy = gwyfile_object_copy(object, GWYFILE_COPY_NONE);
    ...
    /* In this test we must free object only afterwards. */
