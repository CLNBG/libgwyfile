/*
 * $Id: item_char_array_const_setcopy.c 363 2022-02-10 12:15:04Z yeti-dn $
 *
 * Test character array item with constant and copied data.
 *
...
main(void)
{
    ...
    gwyfile_item_set_char_array_copy(item, newvalue, newlen);
