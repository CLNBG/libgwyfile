/*
 * $Id: item_string_array_copy_owned.c 363 2022-02-10 12:15:04Z yeti-dn $
 *
 * Test string array item with copied and owned data.
 *
...
main(void)
{
    ...
    assert(gwyfile_item_get_string_array(item) != value);
