/*
 * $Id: file_error_confinement_array1.c 363 2022-02-10 12:15:04Z yeti-dn $
 *
 * Test confinement error for array size.
 *
...
main(void)
{
    ...
    sprintf(filename, "file_error_confinement_array1.%u.gwy", getpid());
