/*
 * $Id: object_datafield_const.c 372 2022-02-10 15:34:30Z yeti-dn $
 *
 * Test GwyDataField object constructor and extractor with constant data.
 *
...
main(void)
{
    ...
    gwyfile_object_add(datafield, gwyfile_item_new_bool("EXTRA_ITEM", true));
