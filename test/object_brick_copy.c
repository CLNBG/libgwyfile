/*
 * $Id: object_brick_copy.c 363 2022-02-10 12:15:04Z yeti-dn $
 *
 * Test GwyBrick object constructor and extractor with copied data.
 *
...
main(void)
{
    ...
    gwyfile_object_add(brick, gwyfile_item_new_double("EXTRA_ITEM", M_PI));
