/*
 * $Id: object_dataline_copy.c 363 2022-02-10 12:15:04Z yeti-dn $
 *
 * Test GwyDataLine object constructor and extractor with copied data.
 *
...
main(void)
{
    ...
    gwyfile_object_add(dataline, gwyfile_item_new_double("EXTRA_ITEM", M_PI));
