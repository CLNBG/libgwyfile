/*
 * $Id: item_int64_array_owned_owned.c 363 2022-02-10 12:15:04Z yeti-dn $
 *
 * Test int64 array item with owned data.
 *
...
main(void)
{
    ...
    assert(memcmp(gwyfile_item_get_int64_array(item), constvalue,
