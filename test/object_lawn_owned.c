/*
 * $Id: object_lawn_owned.c 378 2022-02-10 16:43:07Z yeti-dn $
 *
 * Test GwyLawn object constructor and extractor with owned data.
 *
...
main(void)
{
    ...
    dataowned = malloc(sizeof(data));
    memcpy(dataowned, data, sizeof(data));
    clenowned = malloc(sizeof(curvelengths));
    memcpy(clenowned, curvelengths, sizeof(curvelengths));
    lawn = gwyfile_object_new_lawn(2, 2, 1, 3.0, 4.0,
                                   "curvelengths", clenowned,
                                   "data", dataowned,
                                   "si_unit_xy", "m",
                                   "xoff", 1.5,
                                   "yoff", -1.0,
