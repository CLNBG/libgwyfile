/*
 * $Id: item_int32_array_owned_setconst.c 363 2022-02-10 12:15:04Z yeti-dn $
 *
 * Test int32 array item with owned and constant data.
 *
...
main(void)
{
    ...
    gwyfile_item_set_int32_array_const(item, newvalue, newlen);
