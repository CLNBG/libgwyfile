/*
 * $Id: check_utf8_type.c 363 2022-02-10 12:15:04Z yeti-dn $
 *
 * Invalid UTF-8 object name (type) validity error.
 *
...
main(void)
{
                  ...
                  gwyfile_item_new_object
                      ("obj2",
                       gwyfile_object_new
                           ("DeeplyNested",
                            gwyfile_item_new_object
                                ("obj", gwyfile_object_new("\xfc", NULL)),
                            NULL)),
                  gwyfile_item_new_object
                      ("invalid", gwyfile_object_new("\xfe", NULL)),
                  NULL);
    assert(object);
    ...
    for (i = 0; i < errlist.n; i++) {
        ...
        assert(error->code == GWYFILE_INVALID_UTF8_TYPE);
    }
