/*
 * $Id: object_surface_owned.c 363 2022-02-10 12:15:04Z yeti-dn $
 *
 * Test GwySurface object constructor and extractor with owned data.
 *
...
main(void)
{
    ...
    gwyfile_object_add(surface, gwyfile_item_new_int32("EXTRA_ITEM", -10));
