/*
 * $Id: item_double_array_const_setcopy.c 363 2022-02-10 12:15:04Z yeti-dn $
 *
 * Test double array item with constant and copied data.
 *
...
main(void)
{
    ...
    gwyfile_item_set_double_array_copy(item, newvalue, newlen);
