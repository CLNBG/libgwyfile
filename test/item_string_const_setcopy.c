/*
 * $Id: item_string_const_setcopy.c 363 2022-02-10 12:15:04Z yeti-dn $
 *
 * Test string item with constant and copied data.
 *
...
main(void)
{
    ...
    gwyfile_item_set_string_copy(item, newvalue);
